  ...
  return [
    {
      id: "rapid",
      label: "Rapid Gateway",
      tagline: "Visa, Mastercard, AMEX, Raast, JazzCash, EasyPaisa",
      description:
        "Pay securely via Rapid Gateway — Visa, Mastercard, AMEX, Raast, JazzCash or EasyPaisa. You return here automatically after payment.",
      ...
      unavailableReason: rapidReady
        ? undefined
        : "Payment gateway is being configured. Please try again shortly.",
    },
  ];
}
